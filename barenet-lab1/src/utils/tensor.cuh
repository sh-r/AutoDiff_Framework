// Ask chatgpt to explain but file makes sense added my own comments
...
// converts to actual memory address
...
// Both below functions on how to free memory on CPU and GPU
template <typename T>
struct cudaDeleter
{
...
// Tensor class that can be on CPU or GPU and basically using malloc to allocate memory
template <typename T>
class Tensor
{
public:
...
// Basically giving us numpy like tensor and functionality but in Cuda C++
