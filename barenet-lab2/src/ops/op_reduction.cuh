...
////////////////////////////////////////////////////
// Group 1: Functors and GPU kernel launchers
////////////////////////////////////////////////////
...
/////////////////////////////////////
// Directly referred from CPU code
/////////////////////////////////////
...
__global__ void op_reduction_kernel_colwise(OpFunc f, Tensor<T> in, Tensor<T> out, Tensor<IT> out_index, bool get_index) {
    ...
    if (get_index) Index(out_index, i, 0) = accum_ind;
    else Index(out, i, 0) = accum;
}
...
__global__ void op_reduction_kernel_rowwise(OpFunc f, Tensor<T> in, Tensor<T> out, Tensor<IT> out_index, bool get_index) {
    ...
    if (get_index) Index(out_index, 0, j) = accum_ind;
    else Index(out, 0, j) = accum;
}

template <typename OpFunc, typename T, typename IT>
void op_reduction_gpu(OpFunc f, const Tensor<T> &in, Tensor<T> &out, Tensor<IT> &out_index, bool get_index) {
    int threads = 256;
